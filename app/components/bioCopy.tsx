...
export default function BioCopy(): JSX.Element {
  ...
  const paragraphs: JSX.Element[] = [
    <p key={0} className="delay-700">
      As a dedicated Frontend Web Developer, I thrive on designing and developing captivating web applications
      that prioritize seamless user interactions.
      Explore some of my standout projects showcased on the&nbsp;
